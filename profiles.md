...
This file is automatically generated and should not be edited manually. Last updated on 2026-08-14.
...
## EPICC: Epidemiological Cost Calculator

EPICC is a Streamlit web application for estimating and comparing the economic cost of outbreak scenarios. Users pick a disease (measles and tuberculosis presets are included), adjust the pre-populated cost and outbreak parameters, and compare multiple scenarios side by side. Parameter sets can be authored and exchanged as YAML or XLSX files, are validated against a generated Pydantic model, and results can be exported as a shareable report for public health officials and other decision makers.

Contact: Edward Wang, George G. Vega Yon (email: george.vegayon@utah.edu)

Links:<br> https://epiforesite.github.io/epicc/, https://epiworldpythonapp.streamlit.app/
...
Links:<br> https://uofuepibio.github.io/measles/, https://github.com/UofUEpiBio/measles
